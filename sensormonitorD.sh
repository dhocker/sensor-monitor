...
# Default-Stop:      0 1 6
# Short-Description: Manages server-monitor as a daemon
...
VENV=/home/pi/Virtualenvs/sensor-monitor3
PATH=$VENV/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin

# Change the next 3 lines to suit where you install your script and what you want to call it
DIR=/home/pi/rpi/sensor-monitor
DAEMON_SCRIPT=$DIR/sensor_monitor.py
DAEMON_NAME=sensormonitorD.sh
